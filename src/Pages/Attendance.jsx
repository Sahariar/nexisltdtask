...
const Attendance = () => {
    ...
    return (
        <section className='attendance-area'>
        ...
        <div className="table-area">
            <div className="text-center w-1/2 bg-primary p-5 mx-auto text-white my-10 rounded-md">
                <h1 className='text-4xl capitalize '>Attendance information
                    </h1></div>
